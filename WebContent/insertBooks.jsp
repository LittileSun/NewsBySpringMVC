...
<html>
	...
	<body>
		<div class="container">
			...
			<h2 class="page-header">即将发布的图书</h2>
			<center>
				<div class="header" id="header">
					<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#avatar-modal" style="margin: 10px;">上传书籍</button>
				</div>
			</center>
					...
					<div class="modal-content">
						...
						<form class="avatar-form">
							<div class="modal-header">
								...
								<h4 class="modal-title" id="avatar-modal-label">上传书籍图片</h4>
							</div>
							<div class="modal-body">
								<div class="avatar-body">
									<div class="avatar-upload">
										...
										<label for="avatarInput" style="line-height: 35px;">上传书籍</label>
            ...
            <div class="bg-form">
            	<h3>书籍信息</h3>
			<form id="form1" class="form-horizontal" action="insertBooks" method="post">
				<input type="hidden" name="bImg" id="bImg" />
				<div class="form-group">
					<label for="" class="col-md-2">书籍名称</label>
					<div class="col-md-10">
						<input id="bName" name="bName" type="text" placeholder="请输入书名" class="form-control" onchange="checkName()" />
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-md-10">
						<textarea id="bInfo" name="bInfo" class="form-control">
						</textarea>
					</div>
				</div>
				<div class="form-group">
