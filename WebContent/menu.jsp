...
<html>
	...
	<body>
		...
		<div class="navbar-left">
			...
			<a href="queryAllBooks.jsp" target="content">显示所有图书信息</a>
			<a href="queryAllInfo.jsp" target="content">显示所有新闻信息</a>
			<a href="queryAllReporter.jsp" target="content">显示所有记者信息</a>
			<a href="queryAllTup.jsp" target="content">显示所有图片信息</a>
			<a href="updateUserPwd.jsp?uId=<%=request.getParameter("uId")%>" target="content">修改密码</a>
		</div>
	</body>
