...
<html>
	...
	<body>
		<div class="container">
			...
			<h2 class="page-header">发布记者信息</h2>
			<center>
				<div class="header" id="header">
<!-- 					<img src="" class="header-img" data-toggle="modal" data-target="#avatar-modal"/> -->
			...
			<form id="form1" class="form-horizontal" action="updateReporterById" method="post">			
				<input type="hidden" name="rId" id="rId" value="<%=request.getParameter("rId")%>"/>
				<input type="hidden" name="rImg" id="rImg" />
				<div class="form-group">
					<label for="" class="col-md-2">记者名字</label>
					<div class="col-md-10">
						<input id="rName" name="rName" type="text" placeholder="输入记者名字" class="form-control" onchange="checkName()" value=""/>
					</div>
				</div>
				<div class="form-group">
					<label for="" class="col-md-2">出生日期</label>
					<div class="col-md-10">
						<input id="rBirthday" name="rBirthday" type="text" placeholder="出生日期" class="form-control"  value=""/>
					</div>
				</div>
				<div class="form-group">
					<label for="" class="col-md-2">个人简介</label>
					<div class="col-md-10">
						<textarea id="rInfo" name="rInfo" class="form-control" value=""> 
						</textarea>
					</div>
				</div>
				<div class="form-group">
