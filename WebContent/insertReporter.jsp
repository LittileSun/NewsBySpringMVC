...
<html>
	...
	<body>
		<div class="container">
			...
			<h2 class="page-header">发布记者新闻</h2>
			<center>
			...
			<form id="form1" class="form-horizontal" action="insertReporter" method="post">
				<input type="hidden" name="rImg" id="rImg" />
				<div class="form-group">
					<label for="" class="col-md-2">记者名字</label>
					<div class="col-md-10">
						<input id="rName" name="rName" type="text" placeholder="输入记者名字" class="form-control" onchange="checkName()" />
					</div>
				</div>
				<div class="form-group">
					<label for="" class="col-md-2">出生日期</label>
					<div class="col-md-10">
						<input id="rBirthday" name="rBirthday" type="text" placeholder="出生日期" class="form-control" />
					</div>
				</div>
				<div class="form-group">
					<label for="" class="col-md-2">个人简介</label>
					<div class="col-md-10">
						<textarea id="rInfo" name="rInfo" class="form-control">
						</textarea>
					</div>
				</div>
				<div class="form-group">
